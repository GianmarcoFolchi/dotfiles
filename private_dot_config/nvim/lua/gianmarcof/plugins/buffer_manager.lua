...
-- ]])
vim.api.nvim_command("autocmd FileType buffer_manager vnoremap J :m '>+1<CR>gv=gv")
vim.api.nvim_command("autocmd FileType buffer_manager vnoremap K :m '<-2<CR>gv=gv")
